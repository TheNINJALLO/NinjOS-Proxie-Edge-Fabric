...
[![Edge Fabric](https://img.shields.io/badge/Edge_Fabric-7.3.2-111827?style=flat-square)](https://github.com/TheNINJALLO/NinjOS-Proxie-Edge-Fabric/releases/tag/v7.3.2)
...
[**Get started**](#get-started) · [**Read the Wiki**](https://github.com/TheNINJALLO/NinjOS-Proxie-Edge-Fabric/wiki) · [**Download v7.3.2**](https://github.com/TheNINJALLO/NinjOS-Proxie-Edge-Fabric/releases/tag/v7.3.2) · [**View Packages**](https://github.com/TheNINJALLO/NinjOS-Proxie-Edge-Fabric/packages) · [**Report an issue**](https://github.com/TheNINJALLO/NinjOS-Proxie-Edge-Fabric/issues)
...
|---|---|---|---|
| Edge Fabric | `7.3.2` | Linux x86_64 | Windows hosts run the Linux runtime through WSL2; no native Windows edge binary is claimed. |
...
| Vanilla Bridge | `7.3.2` | Mojang Bedrock Dedicated Server | Declares minimum engine `1.26.30`, `@minecraft/server` `2.8.0`, and `@minecraft/server-net` `1.0.0-beta.1.26.30-preview.20`. |
| Session Core | `7.3.2` | Node.js 22+ | Pins `bedrock-protocol` `3.57.0`; use the runtime’s pinned dependency set. |
| Dashboard | `7.3.2` | Linux x86_64 | Go 1.23+ is required when building from source. |
| Vanilla Host Agent | `7.3.2` | Linux x86_64 and Windows x86_64 | Used with the Vanilla Bridge when host metrics and `permissions.json` synchronization are needed. |
...
|---|---|---|
| Pterodactyl | [Pterodactyl installation](https://github.com/TheNINJALLO/NinjOS-Proxie-Edge-Fabric/wiki/Pterodactyl-Installation) | [Pterodactyl egg](https://github.com/TheNINJALLO/NinjOS-Proxie-Edge-Fabric/releases/download/v7.3.2/egg-ninjos-proxie-edge-fabric-v7.3.2.json) |
| Linux VPS/dedicated host | [Standalone Linux installation](https://github.com/TheNINJALLO/NinjOS-Proxie-Edge-Fabric/wiki/Standalone-Linux-Installation) | [Linux installer](https://github.com/TheNINJALLO/NinjOS-Proxie-Edge-Fabric/releases/download/v7.3.2/install-standalone.sh) |
...
| Windows 11/Windows Server | [Windows/WSL2 installation](https://github.com/TheNINJALLO/NinjOS-Proxie-Edge-Fabric/wiki/Windows-Installation) | [Windows installer](https://github.com/TheNINJALLO/NinjOS-Proxie-Edge-Fabric/releases/download/v7.3.2/install-windows.ps1) |
| Manual/offline deployment | [Installation index](https://github.com/TheNINJALLO/NinjOS-Proxie-Edge-Fabric/wiki/Installation-Index) | [Complete runtime](https://github.com/TheNINJALLO/NinjOS-Proxie-Edge-Fabric/releases/download/v7.3.2/NinjOS-Proxie-Edge-Fabric-v7.3.2-Runtime.tar.gz) |
...
|---|---|---|---|
| Endstone | Endstone Companion | [Complete companion setup](https://github.com/TheNINJALLO/NinjOS-Proxie-Edge-Fabric/wiki/Endstone-Companion) | [Compiled Linux package](https://github.com/TheNINJALLO/NinjOS-Proxie-Edge-Fabric/releases/download/v7.3.2/NinjOS-Endstone-Companion-v3.6.0-Endstone-0.11.6-Linux-x86_64.zip) |
| Mojang BDS | Vanilla Bridge | [Vanilla Bridge installation](https://github.com/TheNINJALLO/NinjOS-Proxie-Edge-Fabric/wiki/Vanilla-Bridge) | [Behavior pack](https://github.com/TheNINJALLO/NinjOS-Proxie-Edge-Fabric/releases/download/v7.3.2/NinjOS-Vanilla-Bridge-v7.3.2.mcpack) |
...
```bash
docker pull ghcr.io/theninjallo/ninjos-proxie-edge-fabric:7.3.2
```

The moving `latest` tag is also published. Pin `7.3.2` in production for repeatable deployments.
