...
This package is a component of the complete Edge Fabric, not a standalone end-user proxy distribution. Most operators should install the full runtime from the [v7.3.5 Release](https://github.com/TheNINJALLO/NinjOS-Proxie-Edge-Fabric/releases/tag/v7.3.5) and follow the [Wiki](https://github.com/TheNINJALLO/NinjOS-Proxie-Edge-Fabric/wiki).
