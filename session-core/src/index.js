...
function handleProxyCommand (backend, player, packet, descriptor) {
  ...
  if (name === 'server') {
    ...
    player.queue('text', { type: 'system', needs_translation: false, source_name: '', xuid: '', platform_chat_id: '', filtered_message: '', message: '§bNinj-OS Proxie v7.3.11 · Full Proxy Session Core' })
  }
  return true
}
