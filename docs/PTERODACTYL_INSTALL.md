...
This guide installs Ninj-OS Proxie Edge Fabric v7.3.11 on one Pterodactyl server. The same proxy instance can route Transparent Auth and Full Proxy backends.
