...
This guide installs Ninj-OS Proxie Edge Fabric v7.3.4 on one Pterodactyl server. The same proxy instance can route Transparent Auth and Full Proxy backends.
