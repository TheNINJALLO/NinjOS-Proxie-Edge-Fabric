...
This guide installs Ninj-OS Proxie Edge Fabric v7.3.9 on one Pterodactyl server. The same proxy instance can route Transparent Auth and Full Proxy backends.
...
- `endstone`: install Endstone Companion v3.6.1.
