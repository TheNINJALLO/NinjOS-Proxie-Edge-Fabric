...
1. Extract `NinjOS-Proxie-Edge-Fabric-v7.3.13-GitHub-Repository.zip`.
...
- `build-companion.yml`: builds Endstone Companion v3.7.0 against a selected Endstone release and packages the `.so` with the generated guide.
...
```bash
git tag v7.3.13
git push origin v7.3.13
```

The public release contains exactly these seven supported downloads:

```text
egg-ninjos-proxie-edge-fabric-v7.3.13.json
install-standalone.sh
install-windows.ps1
NinjOS-Endstone-Companion-v3.7.0-Endstone-0.11.6-Linux-x86_64.zip
NinjOS-Proxie-Edge-Fabric-v7.3.13-Runtime.tar.gz
NinjOS-Proxie-Edge-Fabric-v7.3.13-Source.zip
NinjOS-Vanilla-Bridge-v7.3.13.mcpack
```
