...
1. Extract `NinjOS-Proxie-Edge-Fabric-v7.3.14-GitHub-Repository.zip`.
...
- `build-companion.yml`: builds Endstone Companion v3.7.1 against a selected Endstone release and packages the `.so` with the generated guide.
...
install-windows.ps1
NinjOS-Endstone-Companion-v3.7.1-Endstone-0.11.6-Linux-x86_64.zip
NinjOS-Proxie-Edge-Fabric-v7.3.14-Runtime.tar.gz
NinjOS-Proxie-Edge-Fabric-v7.3.14-Source.zip
NinjOS-Vanilla-Bridge-v7.3.14.mcpack
```
