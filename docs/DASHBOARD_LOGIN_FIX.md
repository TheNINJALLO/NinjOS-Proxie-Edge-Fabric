# Ninj-OS Proxie v7.3.16 dashboard login fix
...
2. Import `egg-ninjos-proxie-edge-fabric-v7.3.16.json`.
3. Assign it to the existing proxy server.
4. Use **Reinstall**.
5. Upload `NinjOS-Proxie-Edge-Fabric-v7.3.16-Runtime.tar.gz` to the server root.
