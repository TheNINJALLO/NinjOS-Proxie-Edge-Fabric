# Ninj-OS Proxie v7.3.1 dashboard login fix
...
2. Import `egg-ninjos-proxie-edge-fabric-v7.3.1.json`.
3. Assign it to the existing proxy server.
4. Use **Reinstall**.
5. Upload `NinjOS-Proxie-Edge-Fabric-v7.3.1-Runtime.tar.gz` to the server root.
