...
- Pterodactyl: import the v7.3.15 egg and upload the runtime archive.
- Linux: run `sudo ./install-standalone.sh ./NinjOS-Proxie-Edge-Fabric-v7.3.15-Runtime.tar.gz`.
