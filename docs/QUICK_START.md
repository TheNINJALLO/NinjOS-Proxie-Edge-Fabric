...
- Pterodactyl: import the v7.3.13 egg and upload the runtime archive.
- Linux: run `sudo ./install-standalone.sh ./NinjOS-Proxie-Edge-Fabric-v7.3.13-Runtime.tar.gz`.
