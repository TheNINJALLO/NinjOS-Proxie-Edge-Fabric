...
3. Build Endstone Companion v3.6.1 against the exact Endstone API installed on the backend.
...
profile, and choose `operator`. v7.3.12 saves the selection immediately. Fully
