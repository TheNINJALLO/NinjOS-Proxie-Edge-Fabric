...
public:
    void onEnable() override {
        ...
        enqueue_event("companion.enabled", "Ninj-OS Edge Fabric companion v3.7.1 enabled", "info");
        getLogger().info("Ninj-OS Edge Fabric Companion v3.7.1 enabled. Dashboard {}:{} serverId={} secretFingerprint={}",
    ...
    void onDisable() override {
        ...
        getLogger().info("Ninj-OS Edge Fabric Companion v3.7.1 disabled.");
    }
    ...
    bool onCommand(endstone::CommandSender &sender,
        ...
        if (command.getName() == "ninjosproxiemonitor") {
            ...
            if (action == "status") {
                ...
                sender.sendMessage("Ninj-OS Companion v3.7.1: target={}:{} server={} secretFingerprint={}",
                                   config.dashboard_host, config.dashboard_port, config.server_id,
                                   secret_fingerprint(config.shared_secret));
...
ENDSTONE_PLUGIN("ninjos_proxie_companion", "3.7.1", NinjOSProxieCompanion) {
